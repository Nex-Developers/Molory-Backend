...
const removePassword = (0, remove_password_1.default)({ getOtp: otp_1.getOtp, verifyToken: token_1.verifyToken, userDb });
exports.removePassword = removePassword;
const setPassword = (0, set_password_1.default)({ prisma, userDb, deviceDb, verifyToken: token_1.verifyToken, generateToken: token_1.generateToken, saveToken: token_1.saveToken, removeOtp: otp_1.removeOtp, removeTmpToken: token_1.removeTmpToken, hashPassword: password_1.hashPassword });
