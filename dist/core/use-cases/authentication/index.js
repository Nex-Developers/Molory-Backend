...
const change_email_1 = tslib_1.__importDefault(require("./change-email"));
const change_password_1 = tslib_1.__importDefault(require("./change-password"));
const change_phone_number_1 = tslib_1.__importDefault(require("./change-phone-number"));
const confirm_email_1 = tslib_1.__importDefault(require("./confirm-email"));
const confirm_otp_1 = tslib_1.__importDefault(require("./confirm-otp"));
const get_profile_1 = tslib_1.__importDefault(require("./get-profile"));
const recover_password_1 = tslib_1.__importDefault(require("./recover-password"));
const remove_password_1 = tslib_1.__importDefault(require("./remove-password"));
const set_profile_1 = tslib_1.__importDefault(require("./set-profile"));
const sign_in_with_email_and_password_1 = tslib_1.__importDefault(require("./sign-in-with-email-and-password"));
const sign_in_with_phone_number_1 = tslib_1.__importDefault(require("./sign-in-with-phone-number"));
const sign_out_1 = tslib_1.__importDefault(require("./sign-out"));
const sign_up_1 = tslib_1.__importDefault(require("./sign-up"));
const update_avatar_1 = tslib_1.__importDefault(require("./update-avatar"));
const update_profile_1 = tslib_1.__importDefault(require("./update-profile"));
const remove_account_1 = tslib_1.__importDefault(require("./remove-account"));
const add_email_auth_1 = tslib_1.__importDefault(require("./add-email-auth"));
const check_email_1 = tslib_1.__importDefault(require("./check-email"));
const check_password_1 = tslib_1.__importDefault(require("./check-password"));
const update_id_card_1 = tslib_1.__importDefault(require("./update-id-card"));
const update_driver_license_1 = tslib_1.__importDefault(require("./update-driver-license"));
const validate_acount_1 = tslib_1.__importDefault(require("./validate-acount"));
...
const validateAccount = (0, validate_acount_1.default)({ prisma, getOtp: otp_1.getOtp, userDb, deviceDb, generateToken: token_1.generateToken, saveToken: token_1.saveToken, removeOtp: otp_1.removeOtp, removeTmpToken: token_1.removeTmpToken, notifyDevice: notifications_1.notifyDevice, publicationDb });
...
const setProfile = (0, set_profile_1.default)({ userDb, notifyDevice: notifications_1.notifyDevice, publicationDb });
