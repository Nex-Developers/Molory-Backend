...
const confirmOtp = (0, confirm_otp_1.default)({ prisma, notifyDevice: notifications_1.notifyDevice, saveProfile: firebase_1.saveProfile, getOtp: otp_1.getOtp, generateToken: token_1.generateToken, saveToken: token_1.saveToken, removeOtp: otp_1.removeOtp, removeTmpToken: token_1.removeTmpToken });
...
const validateAccount = (0, validate_acount_1.default)({ saveProfile: firebase_1.saveProfile, getOtp: otp_1.getOtp, generateToken: token_1.generateToken, saveToken: token_1.saveToken, removeOtp: otp_1.removeOtp, removeTmpToken: token_1.removeTmpToken, notifyDevice: notifications_1.notifyDevice, saveNotification: firebase_1.saveNotification, publicationDb });
