...
const confirmOtp = (0, confirm_otp_1.default)({ prisma, saveProfile: firebase_1.saveProfile, getOtp: otp_1.getOtp, userDb, deviceDb, generateToken: token_1.generateToken, saveToken: token_1.saveToken, removeOtp: otp_1.removeOtp, removeTmpToken: token_1.removeTmpToken });
