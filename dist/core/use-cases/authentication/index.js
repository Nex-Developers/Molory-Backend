...
const setPassword = (0, set_password_1.default)({ prisma, userDb, deviceDb, generateToken: token_1.generateToken, saveToken: token_1.saveToken, removeOtp: otp_1.removeOtp, removeTmpToken: token_1.removeTmpToken, hashPassword: password_1.hashPassword });
