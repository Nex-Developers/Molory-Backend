...
const confirmOtp = (0, confirm_otp_1.default)({ prisma, notifyDevice: notifications_1.notifyDevice, saveProfile: firebase_1.saveProfile, getOtp: otp_1.getOtp, userDb, deviceDb, generateToken: token_1.generateToken, saveToken: token_1.saveToken, removeOtp: otp_1.removeOtp, removeTmpToken: token_1.removeTmpToken });
...
const validateAccount = (0, validate_acount_1.default)({ saveProfile: firebase_1.saveProfile, prisma, getOtp: otp_1.getOtp, userDb, deviceDb, generateToken: token_1.generateToken, saveToken: token_1.saveToken, removeOtp: otp_1.removeOtp, removeTmpToken: token_1.removeTmpToken, notifyDevice: notifications_1.notifyDevice, saveNotification: firebase_1.saveNotification, publicationDb });
...
const setProfile = (0, set_profile_1.default)({ userDb, notifyDevice: notifications_1.notifyDevice, publicationDb, saveProfile: firebase_1.saveProfile });
...
const updateIdCard = (0, update_id_card_1.default)({ saveProfile: firebase_1.saveProfile, userDb });
exports.updateIdCard = updateIdCard;
const updateDriverLicense = (0, update_driver_license_1.default)({ saveProfile: firebase_1.saveProfile, userDb });
...
const removeAccount = (0, remove_account_1.default)({ saveProfile: firebase_1.saveProfile, userDb, removeToken: token_1.removeToken });
