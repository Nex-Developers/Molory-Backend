...
const addTrip = (0, add_1.default)({ saveProfile: firebase_1.saveProfile, tripDb, vehicleDb, pricingDb, calculMatrix: map_1.calculMatrix, calculPrice: payment_1.calculPrice, notifyUser: notifications_1.notifyUser, addTask: task_1.addTask });
exports.addTrip = addTrip;
const startTrip = (0, start_1.default)({ notifyUser: notifications_1.notifyUser, addTask: task_1.addTask });
exports.startTrip = startTrip;
const finishTrip = (0, finish_1.default)({ notifyUser: notifications_1.notifyUser });
...
const removeTrip = (0, remove_1.default)({ tripDb, notifyUser: notifications_1.notifyUser });
