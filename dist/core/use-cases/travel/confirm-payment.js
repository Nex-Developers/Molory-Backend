...
function makeConfirmPayment() {
    return ({ id, status, amount, method, validatedAt } = {}) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        if (payment.status == 2) {
            return yield prisma.$transaction(() => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                if (travel.seats > remainingSeats)
                    throw new errors_1.InvalidParamError('Missing ' + (travel.seats - remainingSeats) + ' seats');
                ...
                if (principal) {
                    ...
                    yield prisma.route.update({ where: { id: travel.routeId }, data: { remainingSeats: { decrement: travel.seats, } } });
                    ...
                    if (secondaryRoutes.length) {
                        ...
                        if (A !== B)
                            prisma.route.updateMany({ where: { tripId: trip.id, principal: true }, data: { remainingSeats: { decrement: travel.seats, } } });
                    }
                }
                yield prisma.payment.update({ where: { id }, data: { status: 1, method, validatedAt } });
