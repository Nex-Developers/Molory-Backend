...
const removeTravel = (0, remove_1.default)({ travelDb, notifyUser: notifications_1.notifyUser });
exports.removeTravel = removeTravel;
const confirmPayment = (0, confirm_payment_1.default)({ saveProfile: firebase_1.saveProfile, notifyUser: notifications_1.notifyUser });
exports.confirmPayment = confirmPayment;
const rateDriver = (0, rate_driver_1.default)({ saveProfile: firebase_1.saveProfile, notifyUser: notifications_1.notifyUser });
exports.rateDriver = rateDriver;
const ratePassenger = (0, rate_passenger_1.default)({ saveProfile: firebase_1.saveProfile, notifyUser: notifications_1.notifyUser });
