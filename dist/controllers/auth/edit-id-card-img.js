...
function makeEditIdCardImgController({ updateIdCardImg } = {}) {
    if (!updateIdCardImg)
        throw new errors_1.ServerError();
    return function editIdCardImgController(request) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                ...
                delete body.id;
                const data = yield updateIdCardImg(Object.assign({ id }, body));
...
exports.default = makeEditIdCardImgController;
//# sourceMappingURL=edit-id-card-img.js.map