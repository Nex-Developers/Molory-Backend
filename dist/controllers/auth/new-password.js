...
function makeNewPasswordController({ changePassword }) {
    return function newPasswordController(request) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                const token = request.token, { oldPassword, password } = request.body, data = yield changePassword({ id, oldPassword, password, token });
...
exports.default = makeNewPasswordController;
