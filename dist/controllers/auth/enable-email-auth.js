...
function makeEnableEmailAuthController({ addEmailAuth } = {}) {
    if (!addEmailAuth)
    ...
    return function (request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const body = request.body, data = yield addEmailAuth(Object.assign({ id }, body));
...
exports.default = makeEnableEmailAuthController;
//# sourceMappingURL=enable-email-auth.js.map