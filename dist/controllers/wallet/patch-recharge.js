...
function makePatchRechargeController({ rechargeWallet }) {
    return function (request) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                const lang = request.lang, body = request.body, data = yield rechargeWallet(body);
...
exports.default = makePatchRechargeController;
//# sourceMappingURL=patch-recharge.js.map