...
function makePatchWithdrawController({ withdrawWallet }) {
    return function (request) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                const lang = request.lang, body = request.body, data = yield withdrawWallet(body);
...
exports.default = makePatchWithdrawController;
//# sourceMappingURL=patch-withdraw.js.map