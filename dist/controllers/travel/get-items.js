...
function makeGetItemsController({ listTravels }) {
    return function (request) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            const reqLog = {
                ...
                description: `${request.ref.lastName}  ${request.ref.firstName}  ${conventions_1.Action.READ} all travels`
            };
            try {
                const lang = request.lang, body = request.params;
                if (request.ref.role === 'driver')
                    body.userId = request.ref.id;
                const data = yield listTravels(Object.assign({}, body));
