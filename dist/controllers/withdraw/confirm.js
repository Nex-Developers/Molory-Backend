...
function makePostConfirmController({ confirmWithdraw }) {
    return function (request) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            const reqLog = {
                ...
                description: `Fedapay  ${conventions_1.Action.WRITE} withdraw `
            };
            try {
                const lang = request.lang, data = yield confirmWithdraw({ body: request.body, token: request.token });
