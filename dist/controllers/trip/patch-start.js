...
function makePatchStartController({ startTrip }) {
    return function (request) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                const lang = request.lang, body = request.body, data = yield startTrip(Object.assign({}, body));
...
exports.default = makePatchStartController;
