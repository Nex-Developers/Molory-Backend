...
const delete_user_1 = tslib_1.__importDefault(require("./delete-user"));
const deleted_user_1 = tslib_1.__importDefault(require("./deleted-user"));
const deleted_users_1 = tslib_1.__importDefault(require("./deleted-users"));
const get_to_validate_users_1 = tslib_1.__importDefault(require("./get-to-validate-users"));
const get_user_1 = tslib_1.__importDefault(require("./get-user"));
const get_users_1 = tslib_1.__importDefault(require("./get-users"));
const patch_user_1 = tslib_1.__importDefault(require("./patch-user"));
const patch_user_avatar_1 = tslib_1.__importDefault(require("./patch-user-avatar"));
const post_user_1 = tslib_1.__importDefault(require("./post-user"));
const post_validate_driver_license_1 = tslib_1.__importDefault(require("./post-validate-driver-license"));
const post_validate_id_card_1 = tslib_1.__importDefault(require("./post-validate-id-card"));
