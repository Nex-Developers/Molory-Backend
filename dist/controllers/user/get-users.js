...
function makeGetUsersController({ listUsers }) {
    return function getUsersController(request) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            const reqLog = {
                ...
                description: `${request.ref.lastName}  ${request.ref.firstName}  ${conventions_1.Action.READ} all users`
            };
            try {
                const lang = request.lang, body = request.body, data = yield listUsers(Object.assign({}, body));
...
exports.default = makeGetUsersController;
