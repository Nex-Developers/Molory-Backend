...
function makeGetItemsController({ listNewsletters }) {
    return function (request) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const reqLog = {
                ...
                description: `${request.ref.lastName}  ${request.ref.firstName}  ${conventions_1.Action.READ} all newsletters`
            };
            try {
                const lang = request.lang, body = request.body, data = yield listNewsletters(Object.assign({}, body));
