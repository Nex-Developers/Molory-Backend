...
function makeGetItemsController({ listPromotions }) {
    return function (request) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            const reqLog = {
                ...
                description: `${request.ref.lastName}  ${request.ref.firstName}  ${conventions_1.Action.READ} all promotions`
            };
            try {
                const lang = request.lang, body = request.body, data = yield listPromotions(Object.assign({}, body));
