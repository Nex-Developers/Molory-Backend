...
export default function makeNotifyDocumentSubmission({
    ...
    return async function askToConfirmEmail({ name }: any) {
        ...
        sendSlackMessage("L'utilisateur " + name + " a soumis des documents sur la plateforme Molory, veuillez consulter le dashboard d'administration pour les valider.", "C06A0K4BENQ")
