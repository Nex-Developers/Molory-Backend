    ...
    return async ({
        ...
        return await prisma.$transaction(async () => {
            ...
            if (response) {
                ...
                notifyUser({ id: userId, titleRef: { text: 'notification.confirmTravelEnded.title' }, messageRef: { text: 'notification.confirmTravelEnded.message' }, cover: null, data: { type: 'travel', id }, lang: 'fr' })
            } else {
                // updatewith reason
