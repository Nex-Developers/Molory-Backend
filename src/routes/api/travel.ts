...
export default () => {
    ...
    router.post('/ask-to-start-travel',langCheck,expressRouterAdapter(postAskToStartController))
    router.post('/ask-to-end-travel', langCheck,expressRouterAdapter(postAskToEndController))
